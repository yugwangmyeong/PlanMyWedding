...
//    @GetMapping("/shared")
//    public ResponseEntity<List<BudgetDto>> getSharedBudget(@AuthenticationPrincipal CustomUserDetails userDetails) {
//        Long userId = userDetails.getUser().getId();
//        List<BudgetDto> sharedBudgets = budgetService.getBudgetsSharedWith(userId);
