...
// ✅ 페이지네이션 처리
const Pagination = ({ currentPage, totalPages, visiblePageNumbers, handlePageClick, startPage, endPage }) => (
...
const CommunityTopBanner = ({ region, setRegion, sortType, setSortType }) => (
    ...
    try {
      ...
      if (!region && !category && sortType === "latest") {
        ...
        res = await axios.post(
          ...
          { region: region || null, category: category || null, sort: sortType },
          { headers }
        );
      }
      ...
      <div className="community-content">
        ...
        <div className="right-content">
          <div className="community-main-wrapper">
            ...
            <CommunityTopBanner region={region} setRegion={setRegion} sortType={sortType} setSortType={setSortType} />
